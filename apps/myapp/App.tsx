...
import {
  ...
  FlatList, StyleSheet, SafeAreaView, StatusBar, Alert,
} from 'react-native';
...
export default function App(): React.JSX.Element {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Button title="Clear All Done" color="#ff3b30" onPress={() => {
          const remaining = items.filter(i => !i.done);
          setItems(remaining);
          Alert.alert('Cleared', `Removed ${items.length - remaining.length} items`);
        }} />
